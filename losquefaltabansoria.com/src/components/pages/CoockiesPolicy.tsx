...
const CookiesPolicy: React.FC = () => {
  return (
    <main>
      ...
      <p>
        Esta política de cookies fue actualizada por última vez el 06/11/2024 y
        se aplica a los ciudadanos y residentes legales permanentes del Espacio
      ...
      <p>
        Nuestra web,{" "}
        <a href="https://www.sierranortemadrid.org">
          https://www.sierranortemadrid.org
        </a>{" "}
        (en adelante: «la web») utiliza cookies y otras tecnologías relacionadas
        (para mayor comodidad, todas las tecnologías se denominan «cookies»).
        Las cookies también son colocadas por terceros a los que hemos
      ...
      <p>
        Una cookie es un pequeño archivo que se envía junto con las páginas de
        esta web y que tu navegador almacena en el disco duro de su ordenador u
        otro dispositivo. La información almacenada puede ser devuelta a
        nuestros servidores o a los servidores de terceros apropiados durante
      ...
      <h3>6. Cookies usadas</h3>
      <ul>
        <li>WordPress - Funcional</li>
        <li>Elementor - Estadísticas (anónimas)</li>
        <li>Stripe - Funcional</li>
        <li>WPML - Funcional</li>
        <li>Complianz - Funcional</li>
        <li>Google Fonts - Marketing</li>
        <li>Google reCAPTCHA - Marketing</li>
        <li>Google Maps - Marketing</li>
        <li>YouTube - Marketing</li>
        <li>Hotjar - Estadísticas, Funcional</li>
        <li>Google Analytics - Estadísticas</li>
        <li>Wistia - Estadísticas</li>
        <li>Varios - Propósito pendiente de investigación</li>
      </ul>
      ...
      <h4>7.1 Gestiona tus ajustes de consentimiento</h4>
      <ul>
        <li>Funcional: Siempre activo</li>
        <li>Estadísticas</li>
        <li>Marketing</li>
      </ul>

      <h3>8. Activación/desactivación y borrado de cookies</h3>
      <p>
      ...
      <h3>9. Tus derechos con respecto a los datos personales</h3>
      <ul>
        <li>
      ...
      <p>
        a Para ejercer estos derechos, por favor, contacta con nosotros. Por
      ...
      <address>
        ...
        <br />
        Calle Camino Navarro, 27. 28752 Lozoyuela-Navas-Sieteiglesias (Madrid)
        <br />
        España
        <br />
        Web:{" "}
        ...
        <br />
        Correo electrónico:{" "}
        <a href="mailto:info@sierranorte.madrid">info@sierranorte.madrid</a>
        <br />
        Número de teléfono: 918680056
      </address>
      <p>
